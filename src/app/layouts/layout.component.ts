...
import { LAYOUT_VERTICAL, LAYOUT_HORIZONTAL, LAYOUT_WIDTH, LAYOUT_POSITION, SIDEBAR_SIZE, SIDEBAR_COLOR, TOPBAR, LAYOUT_TWOCOLUMN } from './layouts.model';
...
export class LayoutComponent {
  ...
  ngOnInit() {
    ...
    this.LayoutMode(this.layoutTheme);
